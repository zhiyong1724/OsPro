...
void MMU_Init(void)
{
	...
	//MMU_SetMTT(0x00000000,0x03f00000,(int)_start,RW_CB);  //bank0
 ...
 //   
	...
	MMU_SetMTT(0x00000000, 0x00000000,0x30000000,RW_CB);
	MMU_SetMTT(0x30000000, 0x34000000, 0x30000000,RW_CB);
