...
unsigned short _lcd_cache[SCR_YSIZE_TFT][SCR_XSIZE_TFT];

void LCD_L0_SetPixelIndex(int x, int y, int PixelIndex)
{
	//Uart_Printf("LCD_L0_SetPixelIndex x = %d, y = %d, PixelIndex = %d\n", x, y, PixelIndex);
	_lcd_cache[y][x] = (unsigned short)PixelIndex;
}

unsigned int LCD_L0_GetPixelIndex(int x, int y)
{
	//Uart_Printf("LCD_L0_GetPixelIndex x = %d, y = %d\n", x, y);
	return _lcd_cache[y][x];
}

void LCD_copy_to_screen()
{
	int i;
